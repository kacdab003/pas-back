...
const validators = [
  ...
  body("pwr_set").isLength({ min: 0, max: 100 }),
  ...
  body("pressure").isLength({ min: 0, max: 999999 }),
  ...
  body("openingLevelA").isLength({ min: 0, max: 100 }),
  body("openingLevelB").isLength({ min: 0, max: 100 }),
  body("supplyAmount").isLength({ min: 0, max: 1000 }),
  body("lighting").isBoolean(),
  body("isCassetteOpened").isBoolean(),
  body("dabExciter").matches(/\b(?:A|B)\b/),
  body("dabPowerOut").isLength({ min: 0, max: 10000 }),
  body("dabPowerReceived").isLength({ min: 0, max: 10000 }),
  body("dabMer").isLength({ min: 0, max: 10000 }),
  body("dabShoulderUp").isLength({ min: 0, max: 10000 }),
  body("dabShoulderDown").isLength({ min: 0, max: 10000 }),
  body("dabGeneral").notEmpty(),
  body("dabTMA").notEmpty(),
  body("dabTMB").notEmpty(),
  body("accidentDescription").isLength({ min: 0, max: 300 }),
];
